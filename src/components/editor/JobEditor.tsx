...
const JobEditor = ({ content, placeholder, onChange }: JobEditorProps) => {
  ...
  // Editor content değiştiğinde güncelle
  useEffect(() => {
  ...
  return (
    <div className='border rounded-md'>
      ...
      <Divider />
      <EditorContent editor={editor} className='bs-[200px] overflow-y-auto flex p-4' />
    </div>
  )
}
